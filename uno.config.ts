  ...
  shortcuts: [
    {
      ...
      'btn-base': 'py-12px px-30px border-none rounded-11px text-1.09rem font-inherit font-bold cursor-pointer shadow-0_4px_12px_shadow-color-black/20,0_1px_2px_shadow-color-blue-dark/10 transition-background_0.17s,color_0.17s,box-shadow_0.18s mb-0 tracking-0.6px flex-grow-0 h-48px',
      ...
      'btn-orange': 'btn-base bg-accent-orange text-white border-b-2px border-solid border-accent-orange hover:bg-accent-orange/80 shadow-0_4px_12px_shadow-color-black/20,0_1px_2px_shadow-color-blue-dark/10',
